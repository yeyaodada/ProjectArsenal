...
public class ArsenalRecipeGenerator extends RecipeProvider
{
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer)
    {
        ...
        WorkbenchRecipeBuilder.crafting(ArsenalItems.VECTOR.get())
                .addIngredient(WorkbenchIngredient.of(Tags.Items.INGOTS_IRON, 54))
                .addIngredient(WorkbenchIngredient.of(Items.WHITE_CONCRETE, 40))
        ...
        WorkbenchRecipeBuilder.crafting(ArsenalItems.P_NINETY.get())
                ...
                .addCriterion("has_fire_charge", has(Items.FIRE_CHARGE))
                .build(consumer);
        WorkbenchRecipeBuilder.crafting(ArsenalItems.CLASSIC_AR.get())
                .addIngredient(WorkbenchIngredient.of(Tags.Items.INGOTS_IRON, 24))
                .addIngredient(WorkbenchIngredient.of(Items.OAK_PLANKS, 18))
                .addCriterion("has_iron_ingots", has(Tags.Items.INGOTS_IRON))
                .addCriterion("has_oak_planks", has(Items.OAK_PLANKS))
                .build(consumer);
        WorkbenchRecipeBuilder.crafting(ArsenalItems.AUG_CARBINE.get())
                .addIngredient(WorkbenchIngredient.of(Tags.Items.INGOTS_IRON, 50))
                .addIngredient(WorkbenchIngredient.of(Items.GRAY_CONCRETE, 32))
                .addIngredient(WorkbenchIngredient.of(Tags.Items.GEMS_DIAMOND, 2))
                .addIngredient(WorkbenchIngredient.of(Items.FIRE_CHARGE, 1))
                .addCriterion("has_iron_ingots", has(Tags.Items.INGOTS_IRON))
                ...
                .addCriterion("has_fire_charge", has(Items.FIRE_CHARGE))
                .build(consumer);
        WorkbenchRecipeBuilder.crafting(ArsenalItems.FAMAS.get())
                .addIngredient(WorkbenchIngredient.of(Tags.Items.INGOTS_IRON, 70))
                .addIngredient(WorkbenchIngredient.of(Tags.Items.INGOTS_NETHERITE, 2))
                .addIngredient(WorkbenchIngredient.of(Items.REPEATER, 1))
                .addIngredient(WorkbenchIngredient.of(Items.FIRE_CHARGE, 1))
                .addCriterion("has_iron_ingots", has(Tags.Items.INGOTS_IRON))
                .addCriterion("has_netherite_ingots", has(Tags.Items.INGOTS_NETHERITE))
                .addCriterion("has_repeater", has(Items.REPEATER))
                .addCriterion("has_fire_charge", has(Items.FIRE_CHARGE))
                .build(consumer);
        WorkbenchRecipeBuilder.crafting(ArsenalItems.NINETEEN_ELEVEN_MACHINE_PISTOL.get())
                .addIngredient(WorkbenchIngredient.of(Tags.Items.INGOTS_IRON, 75))
                .addIngredient(WorkbenchIngredient.of(Tags.Items.GEMS_DIAMOND, 2))
                .addIngredient(WorkbenchIngredient.of(Items.FIRE_CHARGE, 1))
                .addCriterion("has_iron_ingots", has(Tags.Items.INGOTS_IRON))
                .addCriterion("has_diamond", has(Tags.Items.GEMS_DIAMOND))
                .addCriterion("has_fire_charge", has(Items.FIRE_CHARGE))
                .build(consumer);
        WorkbenchRecipeBuilder.crafting(ArsenalItems.UNICA_MODEL_SIX.get())
                .addIngredient(WorkbenchIngredient.of(Tags.Items.INGOTS_IRON, 50))
                .addIngredient(WorkbenchIngredient.of(Tags.Items.GEMS_EMERALD, 20))
                .addIngredient(WorkbenchIngredient.of(Items.DEAD_BUSH, 1))
                .addIngredient(WorkbenchIngredient.of(Items.FIRE_CHARGE, 1))
                .addCriterion("has_iron_ingots", has(Tags.Items.INGOTS_IRON))
                .addCriterion("has_emerald", has(Tags.Items.GEMS_EMERALD))
                .addCriterion("has_fire_charge", has(Items.FIRE_CHARGE))
                .addCriterion("has_dead_bush", has(Items.DEAD_BUSH))
                .build(consumer);
